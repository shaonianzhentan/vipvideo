...
module.exports = link => {
    return new Promise((resolve, reject) => {
        (async () => {
            ...
            let browser = await puppeteer.launch({ headless: false, args: ['--no-sandbox', '--disable-setuid-sandbox', '--disable-web-security'] });
            ...
            await page.goto(`http://jexi.a0296.cn/?url=${link}`);
